...
const ARCHETYPES = {
  SOLVER: {
    name: "The Solver",
    tagline: "You fix what others ignore.",
    description: "You turn chaos into clarity."
  },
  CONNECTOR: {
    name: "The Connector",
    tagline: "You bring people and ideas together.",
    description: "Relationships become outcomes through you."
  },
  MAKER: {
    name: "The Maker",
    tagline: "You build what does not yet exist.",
    description: "Creation is your natural language."
  },
  VOICE: {
    name: "The Voice",
    tagline: "You move minds and shape attention.",
    description: "Words become force in your hands."
  },
  MERCHANT: {
    name: "The Merchant",
    tagline: "You spot value early.",
    description: "You know how to turn opportunity into wealth."
  },
  ARCHITECT: {
    name: "The Architect",
    tagline: "You design systems that scale.",
    description: "You think beyond tasks into structures."
  },
  HEALER: {
    name: "The Healer",
    tagline: "You reduce pain and restore people.",
    description: "Care becomes transformation through you."
  },
  PERFORMER: {
    name: "The Performer",
    tagline: "You create moments people remember.",
    description: "Energy and emotion move through you."
  }
};
...
You are an elite human potential strategist.

Builder Type: ${arch.name}
Tagline: ${arch.tagline}
Description: ${arch.description}

Make the output powerful, specific, modern, practical, premium and life-changing.
No clichés.
`);
}
...
Be sharp, honest, strategic, useful.
`);
}
...
export default function PipuPath() {
  ...
  function shareWhatsApp() {
    ...
    const text =
      `I discovered my Builder Path on PipuPath: ${title}. Try yours now → https://pipupath-p8we95ssf-synsynlele-3991s-projects.vercel.app`;
  ...
  function shareX() {
    ...
    const text =
      `I discovered my Builder Path on PipuPath: ${title}. Find yours now: https://pipupath-p8we95ssf-synsynlele-3991s-projects.vercel.app`;
  ...
  function copyInvite() {
    navigator.clipboard.writeText(
      "Discover your Builder Path now: https://pipupath-p8we95ssf-synsynlele-3991s-projects.vercel.app"
    );
  ...
  const screens = {
    ...
    questions: (
      <div>
        <div className="pp-logo">PIPUPATH</div>
        <div style={{ opacity: .6, marginBottom: 14 }}>
    ...
    result: (
      <div>
        ...
        <div className="pp-card">
          <div className="pp-card-label">Skill To Master</div>
          {pathData?.skill_one}
        </div>
        ...
        <div className="pp-card">
          <div className="pp-card-label">Offer This Week</div>
        ...
        <button className="pp-btn" onClick={() => setScreen("checkin")}>
          Check In Progress →
        </button>

        <button className="pp-btn-outline" onClick={shareWhatsApp}>
          Share My Builder Path
        </button>

        <button className="pp-btn-outline" onClick={shareX}>
          Share on X
        </button>

        <button className="pp-btn-outline" onClick={copyInvite}>
          Copy Invite Link
        </button>
    ...
    checkin: (
      <div>
        ...
        <textarea
          ...
          value={checkin.tried}
          onChange={(e) =>
            setCheckin({ ...checkin, tried: e.target.value })
          }
        />
        ...
        <textarea
          ...
          onChange={(e) =>
            setCheckin({ ...checkin, worked: e.target.value })
          }
        />
        ...
        <textarea
          ...
          value={checkin.stuck}
          onChange={(e) =>
            setCheckin({ ...checkin, stuck: e.target.value })
          }
        />
    ...
    checkin_result: (
      <div>
        ...
        <div className="pp-card">
          <div className="pp-card-label">Adjustment</div>
